  ...
  return (
    <div className="flex h-screen w-screen items-center justify-center bg-home-hero bg-cover bg-center text-light">
        <div className="w-[85%] text-center">
            ...
            <div className="mx-auto lg:w-[35%]">New Life is a life giving church, Marked by the presence of God, Activating us to Impact others. We Gather in Person and Online.</div> 
